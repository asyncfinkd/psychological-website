...
export default function AdminAboutPages() {
  const { events, setEvents, clicked, setClicked, abouts, setAbouts } =
    ...
    <>
      ...
      <div className={clicked ? "sidebar__none" : "sidebar__container"}>
        <ul className="sidebar__container-ul">
          ...
          <Link to="/admin/about" className="sidebar__container-li">
      ...
      >
        <div className="admin__wrapper__content">
          <div className="admin__wrapper__flex">
            <div>
              <h2 className="admin__wrapper__content__title">შესახებ</h2>
            </div>
          </div>
          <div
                  ...
                  <div className="col-lg-12">
                    <div className="row">
                      {abouts.map((item, i) => {
                        ...
                        return (
                          <>
                            <AboutFeature title={title} description={description} i={i} />
                          </>
                        );
                      })}
                    </div>
