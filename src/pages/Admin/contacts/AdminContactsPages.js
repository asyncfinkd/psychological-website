...
import AdminInfosPagesMap from "../../../components/infos/AdminInfosPagesMap";

export default function AdminContactsPages() {
    ...
    <>
      ...
      <div className={clicked ? "sidebar__none" : "sidebar__container"}>
		...
		c15.7-28.7,26.9-69.1,33.4-114.1h105.6C424.7,409,374.2,451.2,313.3,467.7z"
          ...
          <Link to="/admin/contact" className="sidebar__container-li">
            <div className="sidebar__container-li__content">
              ...
              <p className="sidebar__container-li__paragraph">კონტაქტი</p>
            </div>
          </Link>
        </ul>
      </div>
      ...
      >
        <div className="admin__wrapper__content">
          <div className="admin__wrapper__flex">
            <div>
              <h2 className="admin__wrapper__content__title">კონტაქტი</h2>
            </div>
          </div>
          <div
