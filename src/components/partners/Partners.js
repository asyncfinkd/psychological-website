                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/eurostudies-logowsg_1614779462.png"
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo_en-GB_1614779378.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/stepslogo_1614779290.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo%20(5)_1614779083.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo%20(4)_1614779039.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo%20(3)_1614779003.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo_ge_1614778968.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/Screenshot%20from%202021-03-03%2017-34-20_1614778905.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo%20(2)_1614778861.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/mes.gov.ge-logo-geo_1614778830.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/18222717_1173366582786108_980057008606236575_n_1614778789.jpg"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                    ...
                    <div className="col-md-9 col-lg-9">
                      <div className="partner__featured__content">
                        ...
                        <div>
                          <h5 className="partner__featured__title">
                            შპს თბილისის ფიზიკური ჯანდაცვის კრიზისული
                            ინტერვენციის სამსახური
                          </h5>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo%20(1)_1614778721.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
                ...
                <div className="flex__partner__container">
                  ...
                  >
                    <div className="col-md-3 col-lg-3">
                      <div className="partner__featured__thumbnail">
                        <img
                          src="https://epsy.ge/img/partners/logo_1614778664.png"
                          className="img-fluid partners__image__fluid"
                          alt="qwe"
                        />
                      </div>
